 ...
 */
@WebFilter("/*")
public class HistoryApiFallback implements Filter {
    private static Logger log = Logger.getLogger(HistoryApiFallback.class.getName());
    ...
    protected static String forwardPath = "/index.html";
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        log.info("doFilter: " + doFilter + ", requestURI: " + requestURI);
